...
parser.add_argument('--x', type=int, default=30, help='Number of iterations to perform thinning')
parser.add_argument('--beta', type=int, default=111, help='Beta for Random Walker')
parser.add_argument('--prune', type=int, default=11, help='Number of iterations to perform pruning')

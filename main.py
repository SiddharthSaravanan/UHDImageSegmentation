...
parser.add_argument('--x', type=int, default=33, help='Number of iterations to perform thinning')
parser.add_argument('--beta', type=int, default=104, help='Beta for Random Walker')
...
def main():
	...
	#run random walker
	refine.refinement(args.dataset,args.x,args.beta)
